// frontend/src/pages/analyst/Announcements.jsx
...
export default function Announcements() {
  ...
  // Fetch announcements for analysts
  useEffect(() => {
    const fetchAnnouncements = async () => {
      try {
        setLoading(true);
        console.log("Fetching analyst announcements from:", `${API_BASE}/api/announcements/analyst`);
        
        const res = await fetch(`${API_BASE}/api/announcements/analyst`);
        ...
        console.log("Analyst announcements data received:", data);
        setAnnouncements(data);
      } catch (err) {
        console.error("Error fetching analyst announcements:", err);
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-gray-900">Analyst Announcements</h1>
        <p className="text-sm text-zinc-500 mt-2">
          Important updates and messages from the admin team for analysts
        </p>
      </div>
        ...
        <Card>
          <div className="p-8 text-center">
            ...
            <div className="text-sm text-zinc-500">
              There are no active announcements for analysts at the moment.
            </div>
          </div>
        </Card>
      ) : (
